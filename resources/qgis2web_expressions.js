...
function exp_WATERWAY_2rule0_eval_expression(context) {
    // waterway  IN ('stream', 'pressurized', 'drain', 'ditch', 'canal')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'stream', 'pressurized', 'drain', 'ditch', 'canal'".indexOf(feature.get('waterway') ) > -1 ;
    } else {
        return "'stream', 'pressurized', 'drain', 'ditch', 'canal'".indexOf(feature.get('waterway') ) > -1 ;
    }
}
...
function exp_WATERWAY_2rule1_eval_expression(context) {
    // waterway  IN ('river', 'tidal_channel', 'fairway', 'fish_pass', 'canoe_pass')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'river', 'tidal_channel', 'fairway', 'fish_pass', 'canoe_pass'".indexOf(feature.get('waterway') ) > -1 ;
    } else {
        return "'river', 'tidal_channel', 'fairway', 'fish_pass', 'canoe_pass'".indexOf(feature.get('waterway') ) > -1 ;
    }
}